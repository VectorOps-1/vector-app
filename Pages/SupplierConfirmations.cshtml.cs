...
public class SupplierConfirmationsModel : PageModel
{
    private readonly VectorDbContext _db;
    private readonly CurrentUserService _currentUser;

    public SupplierConfirmationsModel(VectorDbContext db, CurrentUserService currentUser)
    {
        _db = db;
    ...
    public async Task OnGetAsync()
    {
        ...
        var statuses = new[]
        {
            StockOrderStatuses.ReadyToEmailSupplier,
            StockOrderStatuses.SentToSupplier,
