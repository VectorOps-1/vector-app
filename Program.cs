...
builder.Services.AddScoped<ImportGovernanceService>();
...
builder.Services.AddScoped<PremiumAiImportService>();
builder.Services.AddScoped<IProductComplianceAuthorization, DenyProductComplianceAuthorization>();
builder.Services.AddScoped<CompliancePackGovernanceService>();
builder.Services.AddScoped<ComplianceSourceRegistryReader>();
